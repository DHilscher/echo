  ...
  render() {
    ...
    return (
      <ScrollView style={styles.sendFormContainer}>
          ...
          return (
            <View style={styles.sentRecipientWrapper} key={index}>
              <View style={styles.sentRecipientCenter}>
                <Text style={styles.sentRecipientText}>
                  {recipient.recipientName}
                </Text>
                <TouchableOpacity
                  activeOpacity={0.7}
                  onPress={e => this.removeRecipient(e, index)}
                >
                  <Icon
        ...
        <KeyboardAvoidingView
          style={styles.sendEmailContentWrapper}
          behavior="padding"
        >
          ...
          <View style={styles.optionsContainer}>
            <View style={styles.optionWrapper}>
              <View style={styles.optionContentWrapper}>
                <TouchableOpacity
                  activeOpacity={0.7}
                  onPress={() => this.handleCustomMessage()}
                >
                  <Icon
                    name={
                      this.state.customMessage === false ? (
                        "ios-square-outline"
                      ) : (
            ...
            <View style={styles.optionWrapper}>
              <View style={styles.optionContentWrapper}>
                <TouchableOpacity
                  activeOpacity={0.7}
                  onPress={e => this.addAnotherRecipient(e)}
                >
                  <Icon name="ios-add-circle-outline" size={40} color="white" />
                </TouchableOpacity>
