  ...
  render() {
    ...
    return (
      <ScrollView style={styles.settingContainer}>
        ...
        <KeyboardAvoidingView
          style={[styles.settingSection, styles.userInformationSection]}
          behavior="padding"
        >
          ...
          <View>
            {!this.state.showFullname ? (
              <View style={styles.optionContainer}>
                ...
                <TouchableOpacity
                  activeOpacity={0.5}
                  onPress={this._handleFullnameChange}
                >
              ...
              <View style={styles.changeOptionContainer}>
                ...
                <View style={styles.changeOptionButtonsWrapper}>
                  <TouchableOpacity
                    activeOpacity={0.5}
                    onPress={this._handleNameSubmit}
                  >
            ...
            {!this.state.showEmail ? (
              <View style={styles.optionContainer}>
                ...
                <TouchableOpacity
                  activeOpacity={0.5}
                  onPress={this._handleEmailChange}
                >
                  <SmallCustomButton btnText="Change" />
                </TouchableOpacity>
              </View>
              ...
              <View style={styles.changeOptionContainer}>
                ...
                <View style={styles.changeOptionButtonsWrapper}>
                  <TouchableOpacity
                    activeOpacity={0.5}
                    onPress={this._handleEmailSubmit}
                  >
                    <SmallCustomButton btnText="Save" />
                  </TouchableOpacity>
                  <TouchableOpacity
            ...
            {!this.state.showPassword ? (
              ...
              <View style={styles.changeOptionContainer}>
                ...
                <View
                  style={[
                    styles.changeOptionButtonsWrapper,
                    styles.signOutButtons
                  ]}
                >
                  <TouchableOpacity
                    activeOpacity={0.5}
