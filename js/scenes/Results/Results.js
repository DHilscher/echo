...
const Results = ({ ResultTabs, changeTab }) => {
  ...
  return (
    <View style={styles.resultContainer}>
      <View>
        <TouchableWithoutFeedback onPress={() => changeTab('general')} ><View style={styles.generalTab}><Text>General</Text></View></TouchableWithoutFeedback>
        <TouchableWithoutFeedback onPress={() => changeTab('project')} ><View style={styles.projectTab}><Text>Projects</Text></View></TouchableWithoutFeedback>
      </View>
      {activeTab}
